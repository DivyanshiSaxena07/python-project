...
import datetime
import cv2
from constants import CENTER,CANVAS_SIZE,COLORS,RADIUS
def get_ticks():
	hours_init = []
	hours_dest = []
...
def draw_time(image):
    ...
    cv2.line(image,CENTER,(minute_x,minute_y),COLORS['gray'],3)
    ...
    cv2.putText(image,time,(200,380),cv2.FONT_HERSHEY_DUPLEX,1.6,COLORS['red'],1,cv2.LINE_AA)
